...
def obtener_frase_aleatoria():
    frases = [
        ...
        "Estic aprenent a ballar salsa",
        "Tinc ganes de menjar una pizza",
        "Aquest llibre és molt interessant",
        "Em vaig comprar una moto",
        "La meva família és molt important per a mi",
        "M'agrada anar a caminar per la platja",
        "Aquesta ciutat té molts llocs interessants per visitar",
        "El meu plat preferit és la paella",
        "Vull aprendre a tocar la guitarra",
        "M'encanta llegir llibres de ciència ficció",
        "Tenim una oportunitat única enfront de nosaltres",
        "El teu somriure il·lumina el meu dia",
        "Vaig guanyar un premi aquesta setmana",
        "Cada dia és una nova oportunitat",
        "La música és una part important de la meva vida",
        "Tinc molta sort d'haver-te conegut",
        "La vida és plena de sorpreses",
        "El meu lloc preferit és la muntanya",
        "Soc feliç quan estic amb els meus amics"
    ]
...
def main():
   ...
   # texto_ocr = perform_ocr("test4.jpeg")
    #print(texto_ocr)
    """OCR i Correction
    text, data = loadImage("test10.jpeg")       
